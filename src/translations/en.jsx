export default {
  ...
  projects: {
    projects: "Projects",
    text1:
      "A selection of key frontend projects demonstrating my skills in creating responsive, interactive, and user-centered web interfaces. These projects highlight my ability to apply modern technologies such as HTML, CSS, JavaScript, and React while writing clean and maintainable code. They also reflect my growth in implementing real-world UI functionality and delivering practical solutions throughout the IT Academy Frontend Developer Program.",
    project0: {
