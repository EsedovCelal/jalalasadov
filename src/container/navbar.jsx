...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-center fixed top-0 left-0 w-full z-50 px-8">
      <div className="w-full mx-auto max-w-[1300px] backdrop-blur-md flex justify-between items-center px-[40px] py-[0] border-[1px] border-[#3E5F44] rounded-[10px] mt-[5px]">
